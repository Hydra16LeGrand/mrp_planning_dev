...
class MrpPlanning(models.Model):
    ...
    def _process_detail_planning_line_changes(self, vals, old_detail_planning_line, mrp_planning):
        ...
        self._process_updated_detail_planning_lines(section_dl_ids, line_dl_ids, update_dl_ids, old_detail_planning_line, mrp_planning)
    ...
    def _process_updated_detail_planning_lines(self, section_dls, line_dls, update_dl_ids, old_detail_planning_line, mrp_planning):
        for dl in update_dl_ids:
            ...
            if detail:
                if detail['display_type'] == 'line_section':
                    ...
                    large_section = self.env['mrp.detail.planning.line'].browse(sect_dl)
                    large_line = self.env['mrp.detail.planning.line'].browse(line_dl)
                    self._process_large_section_and_line_update(mrp_planning, dl['value'], detail, large_section, large_line)

    # def _process_large_section_and_line_update(self, mrp_planning, dl, detail, large_section, large_line):
